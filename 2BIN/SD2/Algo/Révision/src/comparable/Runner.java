...
public class Runner {
	...
	/**
	 * Comparator permet de trier en remplaçant l'ordre naturel; on peut définir plusieurs comparator tandis que qu'avec Comparable on ne peut pas
	...
	public static void main(String[] args) {
		...
		Collections.sort(laptops); // la méthode sort prend un Type qui implements l'interface comparable
		...
		*/
		...
		// grâce à une classe anonyme (voir plus haut) ou bien avec une lambda expression. 
