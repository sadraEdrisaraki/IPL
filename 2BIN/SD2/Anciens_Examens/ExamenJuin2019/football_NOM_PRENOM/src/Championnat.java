...
public class Championnat {
	...
	private Set<Equipe> equipes = new TreeSet<Equipe>(Comparator.comparing(Equipe::getNbPoints).reversed().thenComparing(Equipe::getNom));
	private Set<Match> matchs = new HashSet<Match>();

	public Championnat(Equipe... equipes) {
		for (Equipe equipe : equipes) {
			System.out.println(equipe.getNom() +" : "+equipe.hashCode());
	...
	public void encoderMatch(Equipe equipeDomicile, Equipe equipeVisiteuse, int nbButDomicile, int nbButVisiteur) {
		...
		System.out.println(equipeDomicile.getNom() +" : "+equipeDomicile.hashCode());
